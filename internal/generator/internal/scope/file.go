...
//
// When true, primo skips generating mutators, builders, and oneof type-switch
// code that would conflict with or be unable to access the opaque struct.
// Oneof accessors use WhichXxx()/HasXxx()/GetXxx() instead of a type switch.
//
