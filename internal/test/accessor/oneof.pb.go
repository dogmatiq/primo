...
var file_github_com_dogmatiq_primo_internal_test_accessor_oneof_proto_rawDesc = []byte{
	...
	0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x74, 0x65, 0x73, 0x74, 0x2f, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73,
	0x6f, 0x72, 0x2f, 0x6f, 0x6e, 0x65, 0x6f, 0x66, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x13,
	...
	0x74, 0x2f, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x6f, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}

var (
	file_github_com_dogmatiq_primo_internal_test_accessor_oneof_proto_rawDescOnce sync.Once
	file_github_com_dogmatiq_primo_internal_test_accessor_oneof_proto_rawDescData = file_github_com_dogmatiq_primo_internal_test_accessor_oneof_proto_rawDesc
)
...
func file_github_com_dogmatiq_primo_internal_test_accessor_oneof_proto_rawDescGZIP() []byte {
	file_github_com_dogmatiq_primo_internal_test_accessor_oneof_proto_rawDescOnce.Do(func() {
		file_github_com_dogmatiq_primo_internal_test_accessor_oneof_proto_rawDescData = protoimpl.X.CompressGZIP(file_github_com_dogmatiq_primo_internal_test_accessor_oneof_proto_rawDescData)
	})
...
var file_github_com_dogmatiq_primo_internal_test_accessor_oneof_proto_goTypes = []interface{}{
...
func file_github_com_dogmatiq_primo_internal_test_accessor_oneof_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_dogmatiq_primo_internal_test_accessor_oneof_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OneOf); i {
			case 0:
				return &v.state
			case 1:
	...
	file_github_com_dogmatiq_primo_internal_test_accessor_oneof_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*OneOf_FieldA)(nil),
		(*OneOf_FieldB)(nil),
		(*OneOf_FieldC)(nil),
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_github_com_dogmatiq_primo_internal_test_accessor_oneof_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_github_com_dogmatiq_primo_internal_test_accessor_oneof_proto_rawDesc = nil
