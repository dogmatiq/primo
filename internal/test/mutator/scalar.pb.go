...
var file_github_com_dogmatiq_primo_internal_test_mutator_scalar_proto_goTypes = []interface{}{
...
func file_github_com_dogmatiq_primo_internal_test_mutator_scalar_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_dogmatiq_primo_internal_test_mutator_scalar_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Scalar); i {
			case 0:
				return &v.state
			case 1:
