...
func file_github_com_dogmatiq_primo_internal_test_grpcstub_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_dogmatiq_primo_internal_test_grpcstub_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_github_com_dogmatiq_primo_internal_test_grpcstub_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
