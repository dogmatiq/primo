...
func (c *serviceClient) Unary(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, Service_Unary_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) ServerStream(ctx context.Context, in *Request, opts ...grpc.CallOption) (Service_ServerStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Service_ServiceDesc.Streams[0], Service_ServerStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *serviceClient) ClientStream(ctx context.Context, opts ...grpc.CallOption) (Service_ClientStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Service_ServiceDesc.Streams[1], Service_ClientStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *serviceClient) BidirectionalStream(ctx context.Context, opts ...grpc.CallOption) (Service_BidirectionalStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Service_ServiceDesc.Streams[2], Service_BidirectionalStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
